...
SQL = "SELECT departments.department_name, COUNT(employees.employee_id) AS 'number_of_employees' FROM departments JOIN employees ON employees.department_id = departments.department_id GROUP BY departments.department_name ORDER BY number_of_employees DESC;"
...
SQL = "SELECT employees.job_id, (MAX(employees.salary) - MIN(employees.salary)) as salary_span FROM employees WHERE employees.job_id != 9 GROUP BY employees.job_id ORDER BY salary_span DESC;"
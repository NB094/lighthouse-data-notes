...
SQL = "SELECT employees.first_name, employees.last_name, employees.department_id FROM employees WHERE (employees.department_id == 3 OR employees.department_id == 10) ORDER BY employees.department_id ASC;"
